! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.webvUI = t() : e.webvUI = t()
}(this, function() {
    return function(e) {
        function t(i) {
        ...
        function o() {
            function e(t) {
                e = r.default.noop, u.addClass("webvUI-animate-fade-out"), a.addClass("webvUI-animate-fade-out").on("animationend webkitAnimationEnd", function() {
                    o.remove(), s = !1, t && t()
                })
            }
            ...
            var o = (0, r.default)(r.default.render(l.default, n)),
                a = o.find(".webvUI-dialog"),
                u = o.find(".webvUI-mask");
            return (0, r.default)("body").append(o), u.addClass("webvUI-animate-fade-in"), a.addClass("webvUI-animate-fade-in"), o.on("click", ".webvUI-dialog__btn", function(e) {
        ...
        e.exports = '<div class="<%=className%>"> <div class=webvUI-mask></div> <div class="webvUI-dialog <% if(isAndroid){ %> webvUI-skin_android <% } %>"> <% if(title){ %> <div class=webvUI-dialog__hd><strong class=webvUI-dialog__title><%=title%></strong></div> <% } %> <div class=webvUI-dialog__bd><%=content%></div> <div class=webvUI-dialog__ft> <% for(var i = 0; i < buttons.length; i++){ %> <a href=javascript:; class="webvUI-dialog__btn webvUI-dialog__btn_<%=buttons[i][\'type\']%>"><%=buttons[i][\'label\']%></a> <% } %> </div> </div> </div> '
    }, function(e, t, n) {
        "use strict";
        ...
        function o() {
            ...
            var n = (0, r.default)(r.default.render(l.default, t)),
                i = n.find(".webvUI-toast"),
                o = n.find(".webvUI-mask");
            return (0, r.default)("body").append(n), i.addClass("webvUI-animate-fade-in"), o.addClass("webvUI-animate-fade-in"), setTimeout(function() {
                o.addClass("webvUI-animate-fade-out"), i.addClass("webvUI-animate-fade-out").on("animationend webkitAnimationEnd", function() {
        ...
        e.exports = '<div class="<%= className %>"> <div class=webvUI-mask_transparent></div> <div class=webvUI-toast> <i class="webvUI-icon_toast webvUI-icon-success-no-circle"></i> <p class=webvUI-toast__content><%=content%></p> </div> </div> '
    }, function(e, t, n) {
        "use strict";
        ...
        function o() {
            ...
            var o = (0, r.default)(r.default.render(l.default, i)),
                a = o.find(".webvUI-toast"),
                u = o.find(".webvUI-mask");
            return (0, r.default)("body").append(o), a.addClass("webvUI-animate-fade-in"), u.addClass("webvUI-animate-fade-in"), s = o[0], s.hide = t, s
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        });
        ...
        e.exports = '<div class="webvUI-loading_toast <%= className %>"> <div class=webvUI-mask_transparent></div> <div class=webvUI-toast> <i class="webvUI-loading webvUI-icon_toast"></i> <p class=webvUI-toast__content><%=content%></p> </div> </div> '
    }, function(e, t, n) {
        "use strict";
        ...
        function o() {
            function e(t) {
                e = r.default.noop, d.addClass(o.isAndroid ? "webvUI-animate-fade-out" : "webvUI-animate-slide-down"), f.addClass("webvUI-animate-fade-out").on("animationend webkitAnimationEnd", function() {
            ...
            var u = (0, r.default)(r.default.render(l.default, o)),
                d = u.find(".webvUI-actionsheet"),
                f = u.find(".webvUI-mask");
            return (0, r.default)("body").append(u), r.default.getStyle(d[0], "transform"), d.addClass(o.isAndroid ? "webvUI-animate-fade-in" : "webvUI-animate-slide-up"), f.addClass("webvUI-animate-fade-in").on("click", function() {
                t()
            }), u.find(".webvUI-actionsheet__menu").on("click", ".webvUI-actionsheet__cell", function(e) {
                var i = (0, r.default)(this).index();
                n[i].onClick.call(this, e), t()
            }), u.find(".webvUI-actionsheet__action").on("click", ".webvUI-actionsheet__cell", function(e) {
        ...
        e.exports = '<div class="<% if(isAndroid){ %>webvUI-skin_android <% } %><%= className %>"> <div class=webvUI-mask></div> <div class=webvUI-actionsheet> <div class=webvUI-actionsheet__menu> <% for(var i = 0; i < menus.length; i++){ %> <div class=webvUI-actionsheet__cell><%= menus[i].label %></div> <% } %> </div> <div class=webvUI-actionsheet__action> <% for(var j = 0; j < actions.length; j++){ %> <div class=webvUI-actionsheet__cell><%= actions[j].label %></div> <% } %> </div> </div> </div> '
    }, function(e, t, n) {
        "use strict";
        ...
        e.exports = '<div class="webvUI-toptips webvUI-toptips_warn <%= className %>" style=display:block><%= content %></div> '
    }, function(e, t, n) {
        "use strict";
        ...
        function o(e) {
            ...
            return t.forEach(function(e) {
                function t() {
                    o.val(""), n.removeClass("webvUI-search-bar_focusing")
                }
                var n = (0, r.default)(e),
                    i = n.find(".webvUI-search-bar__label"),
                    o = n.find(".webvUI-search-bar__input"),
                    a = n.find(".webvUI-icon-clear"),
                    u = n.find(".webvUI-search-bar__cancel-btn");
                i.on("click", function() {
                    n.addClass("webvUI-search-bar_focusing"), o[0].focus()
                }), o.on("blur", function() {
                    this.value.length || t()
                }), a.on("click", function() {
                    o.val(""), o[0].focus()
        ...
        function o(e) {
            ...
            return t = r.default.extend({
                ...
                var n = (0, r.default)(e),
                    i = n.find(".webvUI-navbar__item, .webvUI-tabbar__item"),
                    o = n.find(".webvUI-tab__content");
                i.eq(t.defaultIndex).addClass("webvUI-bar__item_on"), o.eq(t.defaultIndex).show(), i.on("click", function() {
                    var e = (0, r.default)(this),
                        n = e.index();
                    i.removeClass("webvUI-bar__item_on"), e.addClass("webvUI-bar__item_on"), o.hide(), o.eq(n).show(), t.onChange.call(this, n)
                })
            }), this
        }
        Object.defineProperty(t, "__esModule", {
        ...
        function o(e) {
            return e && e.classList ? e.classList.contains("webvUI-cell") ? e : o(e.parentNode) : null
        }
        ...
        function l(e) {
            if (e) {
                ...
                var a = o(e.ele);
                a && a.classList.add("webvUI-cell_warn")
            }
        }

        function s(e) {
            var t = o(e);
            t && t.classList.remove("webvUI-cell_warn")
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        });
        ...
        function o(e, t) {
            function n(e, t) {
                var n = e.find('[data-id="' + t + '"]'),
                    i = n.find(".webvUI-uploader__file-content");
                return i.length || (i = (0, r.default)('<div class="webvUI-uploader__file-content"></div>'), n.append(i)), n.addClass("webvUI-uploader__file_status"), i
            }

            function i(e, t) {
                var n = e.find('[data-id="' + t + '"]').removeClass("webvUI-uploader__file_status");
                n.find(".webvUI-uploader__file-content").remove()
            }
            ...
            t = r.default.extend({
                ...
                t.onBeforeQueued = function(t, n) {
                    ...
                    if (i !== !0) {
                        ...
                        a.find(".webvUI-uploader__files").append(o)
                    }
                }
            }(), t.onQueued && ! function() {
                var e = t.onQueued;
                ...
                t.onError = function(t, i) {
                    t.status = "fail", e.call(t, i) || n(a, t.id).html('<i class="webvUI-icon-warn"></i>')
                }
        ...
        e.exports = '<li class="webvUI-uploader__file webvUI-uploader__file_status" data-id="<%= id %>"> <div class=webvUI-uploader__file-content> <i class=webvUI-loading style=width:30px;height:30px></i> </div> </li> '
    }, function(e, t) {
        "use strict";
        ...
        function r() {
            function e() {
                (0, d.default)(r.container).append(v), d.default.getStyle(v[0], "transform"), v.find(".webvUI-mask").addClass("webvUI-animate-fade-in"), v.find(".webvUI-picker").addClass("webvUI-animate-slide-up")
            }

            function t(e) {
                t = d.default.noop, v.find(".webvUI-mask").addClass("webvUI-animate-fade-out"), v.find(".webvUI-picker").addClass("webvUI-animate-slide-down").on("animationend webkitAnimationEnd", function() {
            ...
            function i(e, t) {
                ...
                v.find(".webvUI-picker__group").eq(t).scroll({
                    items: e,
                    temp: p[t],
                    onChange: function(e, n) {
                        if (e ? c[t] = new a(e) : c[t] = null, p[t] = n, s) c.length == y && r.onChange(c);
                        else if (e.children && e.children.length > 0) v.find(".webvUI-picker__group").eq(t + 1).show(), !s && i(e.children, t + 1);
                        else {
                            var o = v.find(".webvUI-picker__group");
            ...
            return v.find(".webvUI-picker__bd").html(b), e(), s ? u.forEach(function(e, t) {
                i(e, t)
            }) : i(u, 0), v.on("click", ".webvUI-mask", function() {
                n()
            }).on("click", ".webvUI-picker__action", function() {
                n()
            }).on("click", "#webvUI-picker-confirm", function() {
                r.onConfirm(c)
            }), g = v[0], g.hide = n, g
        }
        ...
        r.default.fn.scroll = function(e) {
            ...
            var a = this,
                p = r.default.extend({
                    items: [],
                    scrollable: ".webvUI-picker__content",
                    offset: 3,
                    rowHeight: 34,
                    onChange: r.default.noop,
                    temp: null,
                ...
                h = p.items.map(function(e) {
                    return '<div class="webvUI-picker__item' + (e.disabled ? " webvUI-picker__item_disabled" : "") + '">' + ("object" == ("undefined" == typeof e ? "undefined" : o(e)) ? e.label : e) + "</div>"
                }).join(""),
                v = (0, r.default)(this);
            v.find(".webvUI-picker__content").html(h);
        ...
        e.exports = '<div class="<%= className %>"> <div class=webvUI-mask></div> <div class=webvUI-picker> <div class=webvUI-picker__hd> <a href=javascript:; data-action=cancel class=webvUI-picker__action>Cancel</a> <a href=javascript:; data-action=select class=webvUI-picker__action id=webvUI-picker-confirm>OK</a> </div> <div class=webvUI-picker__bd></div> </div> </div> '
    }, function(e, t) {
        e.exports = "<div class=webvUI-picker__group> <div class=webvUI-picker__mask></div> <div class=webvUI-picker__indicator></div> <div class=webvUI-picker__content></div> </div>"
    }, function(e, t, n) {
        "use strict";
        ...
        function o(e) {
            function t(e) {
                t = r.default.noop, o.addClass("webvUI-animate-fade-out").on("animationend webkitAnimationEnd", function() {
                    o.remove(), s = !1, e && e()
                })
            }
            ...
            return (0, r.default)("body").append(o), o.find(".webvUI-gallery__img").on("click", function() {
                n()
            }), o.find(".webvUI-gallery__del").on("click", function() {
                i.onDelete.call(this, e)
            }), o.show().addClass("webvUI-animate-fade-in"), s = o[0], s.hide = n, s
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        });
        ...
        e.exports = '<div class="webvUI-gallery <%= className %>"> <span class=webvUI-gallery__img style="background-image:url(<%= url %>)"></span> <div class=webvUI-gallery__opr> <a href=javascript: class=webvUI-gallery__del> <i class="webvUI-icon-delete webvUI-icon_gallery-delete"></i> </a> </div> </div> '
    }, function(e, t, n) {
        "use strict";
        ...
        function o(e) {
            ...
            return n.forEach(function(e) {
                ...
                var o = (0, r.default)(e),
                    a = o.find(".webvUI-slider__inner"),
                    u = o.find(".webvUI-slider__track"),
                    l = o.find(".webvUI-slider__handler"),
